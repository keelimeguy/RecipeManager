...
class SearchWindow(Frame):
    def __init__(self, master, root, type=None, objects="objects"):
        ...
        self.any_label = Label(self.master, text="Any of these terms:").grid(row=2, column=0, columnspan=2, sticky=E)
        ...
        self.none_label = Label(self.master, text="None of these terms:").grid(row=3, column=0, columnspan=2, sticky=E)
        ...
        Label(self.master, text="").grid(row=4, column=6)

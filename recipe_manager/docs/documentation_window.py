...
class DocumentationWindow(object):
    ...
    def __init__(self, root):
        ...
        self.canvas = Canvas(self.master, borderwidth=0, width=640, height=560)
        wrap_width = 640
        ...
        self.description_frame = Frame(self.frame)
        self.description_frame.grid(row = 0, column = 0, sticky=NSEW)

        self.doc_title = Label(self.description_frame, text="<Title>", font=("Times", 12, "bold"))
        self.doc_title.grid(row = 0, column = 0, columnspan = 2, padx = 2, pady = 2)

        self.doc_desc = Label(self.description_frame, text="<Description>", justify=LEFT, wraplength=wrap_width)
